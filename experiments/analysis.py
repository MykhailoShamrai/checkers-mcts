...
def plot_full_overview(df: pd.DataFrame, stats: pd.DataFrame, output_dir: Path) -> None:
    ...
    ax.set_title('Przegląd wszystkich eksperymentów (20 seedów × 2 kolory każdy)')
